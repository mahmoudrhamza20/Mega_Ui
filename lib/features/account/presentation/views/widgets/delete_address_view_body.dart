...
class DeleteAddressViewBody extends StatelessWidget {
  const DeleteAddressViewBody({Key? key}) : super(key: key);
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(' Are you sure wanna delete address',style: Styles.textStyle12.copyWith(color:const Color(0xff223263).withOpacity(0.5)),),
